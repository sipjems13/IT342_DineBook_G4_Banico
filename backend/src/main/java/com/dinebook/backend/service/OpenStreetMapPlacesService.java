 ...
 *
 * Notes:
 * - No menu/photos guaranteed (depends on OSM data).
 * - Provides name/location/cuisine best-effort so it matches your current DB schema.
 */
@Service
